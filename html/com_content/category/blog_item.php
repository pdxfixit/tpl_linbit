    ...
    <div class="rt-article"><div class="rt-article-bg">
            ...
            if (!empty($this->item->images)) {
                ...
                if (!empty($article_images->image_intro)) {
                    $article_image = (string) $article_images->image_intro;
                    $article_image_float = (string) $article_images->float_intro;
                    $article_image_alt = (string) $this->escape($article_images->image_intro_alt);
                    $article_image_caption = (string) $this->escape($article_images->image_intro_caption);

                    /* float to style */
                    if (!empty($article_image_float)) {
                        $article_image_style = "float: $article_image_float;";
                        if (strtolower($article_image_float) == "left") {
                            $article_image_style .= " margin: 0 5px 5px 0;";
                        } elseif(strtolower($article_image_float) == "right") {
                            $article_image_style .= " margin: 0 0 5px 5px;";
                        } else {
                            $article_image_style .= " margin: 5px;";
                        }
                    } else {
                        $article_image_style = "margin: 5px;";
                    }
                    echo '<img src="' . $article_image . '" alt="' . $article_image_alt . '" title="' . $article_image_caption . '" class="article-intro" style="' . $article_image_style . '" />';
                }
                echo '</a>';
            }
            
            /** Begin Article Title * */ if ($params->get('show_title')) : ?>
                <h2 class="title">
